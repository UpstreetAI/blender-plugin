...
bl_info = {
    'name': 'Upstreet Exporter',
    'author': 'Upstreet',
    "version": (0, 0, 1),
    'blender': (2, 91, 0),
    'location': 'File > Import-Export',
    'description': 'Export to Upstreet',
    'warning': '',
...
class ExportGLTF2(bpy.types.Operator, ExportGLTF2_Base, ExportHelper):
    """Export scene as .glb NFT in Upstreet"""
    bl_idname = 'export_scene.upstreet'
    bl_label = 'Export Upstreet NFT (.glb)'
...
def menu_func_export(self, context):
    self.layout.operator(ExportGLTF2.bl_idname, text='Upstreet NFT (.glb)')

def menu_func_export2(self, context):
    self.layout.operator(ExportGLTF2.bl_idname, text='Upstreet Avatar (.vrm)')

class ImportGLTF2(Operator, ImportHelper):
    """Load a glTF 2.0 file"""
    bl_idname = 'import_scene.upstreet'
